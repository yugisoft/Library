 ...
 */
public class FloatingNumPadView extends KeyboardView
{
     ...
     */
    public FloatingNumPadView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public static void setAllignBottomCenter(boolean allignBottomCenter) {
        FloatingNumPadView.allignBottomCenter = allignBottomCenter;
    }
...
//        return new Rect(leftMargin, topMargin, leftMargin + width, topMargin + height);
    ...
    private OnKeyboardActionListener mOnKeyboardActionListener = new OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            } else if (primaryCode == Keys.CLEAR) {
                if (editable != null)
                {
                    editable.clear();
                    editable.insert(0, "1");
                    ...
                    if (onEnterListener!=null)
                        onEnterListener.onTextChaned(edittext.getText().toString());
                }
            ...
            else if (primaryCode == Keys.NUMPAD_ENTER || primaryCode == Keys.ENTER || primaryCode == Keys.DPAD_CENTER)
            {
                if (onEnterListener!=null)
    ...
    public interface  OnEnterListener
    {
        ...
        void onTextChaned(String Value);
    }
}
