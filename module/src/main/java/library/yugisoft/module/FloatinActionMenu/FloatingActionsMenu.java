package library.yugisoft.module.FloatinActionMenu;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private boolean collapseForClick = true ;
    ...
    public boolean isCollapseForClick() {
        return collapseForClick;
    }

    public void setCollapseForClick(boolean collapseForClick) {
        this.collapseForClick = collapseForClick;
    }
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        setCollapseForClick(attr.getBoolean(R.styleable.FloatingActionsMenu_fab_collapseForClick,true));
